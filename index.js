...
//----------------------MQTT-------------------------
var options = {
    host: 'b93b66d2b764454088e3e2094f95e853.s1.eu.hivemq.cloud',
    port: 8883,
    protocol: 'mqtts',
    username: 'tungtran',
    password: 'T16825ds5230'
}
...
var con = mysql.createConnection({
    ...
    port: 3306,
    user: 'tung',
    password: '16825ds5230',
    database: 'tung_database'
});
// //---------------------------------------------CREATE TABLE-------------------------------------------------
con.connect(function (err) {
    if (err) throw err;
    console.log("mysql connected");
    var sql = "CREATE TABLE IF NOT EXISTS sensors11(ID int(10) not null primary key auto_increment,  Time datetime not null, Temperature int(3) not null, Humidity int(3) not null, Light int(5) not null,ariconditioning int(5) not null )"
